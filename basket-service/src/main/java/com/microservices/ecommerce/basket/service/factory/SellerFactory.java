...
public class SellerFactory {
    ...
    public static Seller createTestSeller() {
        ...
        Seller seller = new Seller(1,5,10, List.of(testUser1, testUser2));
        return seller;
    }
    ...
    public static Seller createSellerWithOneUser(long sellerId, int stock, float price, long userId, int quantity) {
        ...
        Seller seller = new Seller(sellerId, stock, price, List.of(user));
        return seller;
    }

    public static Seller createSeller(long id, int stock, float price) {
        Seller seller = new Seller(id, stock, price, List.of());
        return seller;
    }

    public static Seller createSellerWithUser(long id, int stock, float price, User user) {
        Seller seller = new Seller(id, stock, price, List.of(user));
        return seller;
    }

    public static Seller createSellerWithUserList(long id, int stock, float price, List<User> users) {
