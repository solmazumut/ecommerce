...
public class BasketNotificationEvent {
    ...
    public BasketNotificationEvent() {
    }

    public BasketNotificationEvent(ArrayList<Long> userIdList, String message, String topicName, long productId, String productTitle) {
